...
public class EventManager : Singleton<EventManager> {
	...
	public static void TryRemoveListener<T> (EventDelegate<T> del) where T : GameEvent {
	...
	public void TriggerEvent (GameEvent e) {
		...
		if (delegates.TryGetValue(e.GetType(), out del)) {
			...
			//if (e == null)
			//	Debug.Log ("GameEvent IS NUll");
			//Debug.Log("1.TriggerEvent");
			foreach(EventDelegate k in delegates[e.GetType()].GetInvocationList()){
				//Debug.Log ("TriggerEvent :: "+k.Method.Name);
